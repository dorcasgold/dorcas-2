      ...
      <div className="flex flex-col gap-8 items-center">
        ...
        <div className="mt-5">
          <div className="grid grid-cols-2 sm:grid-cols-5 gap-8">
            <div className="border-gray-500 h-40 rounded-md border w-40 text-center justify-center items-center px-2 py-2 gap-5  flex flex-col">
            ...
            <div className="border-gray-500 h-40 rounded-md border w-40 text-center justify-center items-center px-2 py-2 gap-5  flex flex-col">
              <img className="imgIcon" src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/javascript/javascript-original.svg" />
            ...
            <div className="border-gray-500 h-40 rounded-md border w-40 text-center justify-center items-center px-2 py-2 gap-5  flex flex-col">
              <img className="imgIcon" src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/figma/figma-original.svg" />
